...
1. 상대방의 의도를 이해하고 **존중**하는 것.
2. 상대가 선한 마음으로 더 나은 결과를 위해 리뷰를 했다는 믿음을 갖는 것.
3. 내 생각이 틀렸을 수 있다는 수용의 여지를 남기는 것.
4. 레퍼런스를 통해 판단 근거를 제공하는 것.
5. 구체적 개선 포인트, 리스크 요인을 설명하는 것.
...
> **FE 인터뷰 프로세스 개선**
>
> - 모집 인재상 구체화 (팀에서 원하는 인재는 어떤 사람인지?)
> - 타겟팅한 인재상을 알아보기 위한 인터뷰 질문 개선 (현재 프로젝트에서 사용되고 있는 기술, 팀이 원하는 핵심 가치, 문제에 대한 접근 방식)
> - 인터뷰 리뷰를 통해 팀이 원하는 인재상을 재검토 (어떤 가치를 중요하게 생각하고 어떤 부분에서 아쉬움을 느끼는지?)
