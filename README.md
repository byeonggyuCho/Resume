...
- 역할: react기반 웹 프론트엔드
- 작업:
  1. [관리자웹](https://manager.albacheck.com/)
  2. [어드민]()
...
- 상대방의 언어로 말하며 `디자이너`와 기획자와 원활한 커뮤니케이션을 할 수 있도록 노력합니다.
...
- ES6+ 문법에 익숙합니다.
- `prototype`기반 OOP를 충분히 이해하고 있습니다.
...
### 4.프론트엔드 개발자는 어떤 역할을 하는지

고객이 제품을 만나는 첫 순간이 프론트 엔드입니다.  
그렇기 때문에 프론트엔드 개발자에게 가장 중요한 것은 엔드 유저의 경험을 공감하는 것이라 생각합니다.  
사용자 관점에서 자연스러운 사고 흐름에 기반한 웹 접근성을 제공하는 것과 부드러운 인터렉션을 경험하게 하는것을 가장 중요하게 생각합니다.
...
제가 React를 학습한 이유는 모바일 웹의 성장에 따른 인터렉티브한 웹의 수요가 증가할 것이라 판단했기 때문입니다.  
그 중 SPA 프레임워크에서 가장 인지도가 높은 React를 선택했습니다.

React는 간단히 소개하자면 랜더링 최적화를 자동화 해줌으로써 인터렉티브한 웹과 앱을 만들기 위한 라이브러리라고 할 수 있습니다.
...
### 8.Typescript를 사용함으로써 얻을 수 있는 장점은 무엇인가요
...
### 9. 스타트업에서 가장 중요한 것은 무엇이라 생각하나

시장을 선점하는 것과 시장과 탄력적인 소통을 지속하는 것이라 생각합니다.  
초기 스타트업이 사업을 이어나가기 위해선 사업 아이템을 빨리 시장검증을 통해 정량적 통계를 얻어 내는 것이 중요합니다.  
그렇기 때문에 스타트업은 속도전이라고 생각합니다.

### 10. 스타트업에 근무하며 느낀점이 있다면

SI부서에서 가장 중요한 것은 납품기간을 준수하는 것입니다.
이미 기획과 설계가 되있는 시점에 투입되어 텍스트와 이미지로 이뤄진 기획서를 코드로 전환하는 작업만 했기 때문에 능동적으로 제품과 서비스에 대해 고민할 기회가 적습니다.
...
보다 주도적 환경에서 일하며 한 기업에 취업해서 `일을 하는 것`이 단순히 경제활동을 하는것 외에 어떤 의미가 있는지 스스로 되돌아보게 되었습니다.  
돈 버는 것 이외에 일에 대한 새로운 가치를 찾고 싶은 사람, 스스로 고민하며 문제해결하는 것을 즐기는 사람.  
그런 사람이라면 한번쯤 스타트업에 도전해보시길 바랍니다.

### 11. 스타트업에서 일하며 느꼈던 어려움이 있다면
