...
- Skill
  ...
  - back: Java, Node.js, Mysql, MongoDB
...
- 작업 내용
  ...
  - [Paple](https://www.payple.kr/)모듈을 이용한 카드 등록 및 `결제 서비스` 개발.
  - `JWT`기반 사용자 인증
...
큰 조직에서 분업화된 환경에서만 일을 했다면 이런 환경에서 스케줄을 조율하는 것에 스트레스를 받을 수 있습니다.  
이리 저리 불려다니다가 시간을 뺐겨서 정작 자기 할일을 못하거나 자동화 시스템이 없어서 생기는 잡무를 처리하느라 시간을 뺐기는 경우가 허다합니다.
